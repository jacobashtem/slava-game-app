...
const SCENARIO_MAP: Record<string, ScenarioConfig> = {
  ...
  'chmurnik_ground_flying': {
    hint: 'Chmurnik: aktywuj zdolność aby uziemić WSZYSTKIE latające wrogie istoty (raz na turę). AI ma same latające!',
    aiL1: ['gryf_double_dmg_on_play_turn'],
    aiL2: ['zar_ptak_death_explosion'],
    aiL3: ['blotnik_taunt'],
  },
  'chowaniec_intercept': {
    hint: 'Chowaniec: gdy wróg atakuje sojusznika, może przejąć walkę na siebie. Kliknij Tak żeby Chowaniec oberwał zamiast Gryfa.',
    startOnField: true,
    allyL1: ['chowaniec_intercept', 'gryf_double_dmg_on_play_turn'],
    aiL1: ['leszy_post_attack_defend'],
    aiL2: [],
    aiL3: [],
  },
  'dziewiatko_deathmark': {
    hint: 'Dziewiątko: aktywuj zdolność! Żądło dystansowe, ginie, wybierz truciznę lub paraliż. Sparaliżuj Dobroochoczego — jego aura powinna przestać działać.',
    startOnField: true,
    allyL1: ['chowaniec_intercept'],
    handExtras: ['blotnik_taunt', 'rusalka_mirror_attack'],
    aiL1: ['dobroochoczy_no_counter', 'gryf_double_dmg_on_play_turn'],
    aiL2: [],
    aiL3: [],
  },
